...
public class SearchTree implements NodeList{
    ...
    public boolean addItem(ListItem newItem) {
        if (this.root == null) {
            // the tree was empty, so the item becomes the head of the tree.
            this.root = newItem;
            return true;
        }
        // otherwise, start comparing the head of the tree.
        ...
        while (currentItem != null) {
            ...
            if (comparison < 0) {
                ...
                // newItem is less than root, move left if possible
        ...
        // we can't get there but java compiler complains if there is no return
        return false;
    }
